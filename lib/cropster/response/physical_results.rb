...
module Cropster::Response
  class PhysicalResults < Cropster::Response::FormattedResponseItem
    ...
    :density_volume_unit,
    :density_volume_amount_si,
    :density_weight_amount,
    :density_weight_unit,
    :density_weight_amount_si,
    :milling_weight_difference_amount,
    :milling_weight_difference_units,
    :milling_weight_difference_amount_si,
    :roasted_weight_amount,
    :roasted_weight_unit, 
    :moisture_unit,
    :moisture_amount,
    :parchment_weight_unit,
    :parchment_weight_amount,
    :green_weight_unit,
    :green_weight_amount,
    :temperature_unit,
    :temperature_amount,
