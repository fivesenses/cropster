...
class Cropster::ProfileComponentTest < Test::Unit::TestCase
  def test_profile_component_success
    ...
    profile_component = Cropster::ProfileComponent.new(cropster_client).profile_component("6XdV8")
  ...
  test "should get a collection of ProfileComponents" do
    ...
    profile_components = Cropster::ProfileComponent.new(cropster_client).profile_components
  ...
  def register_fixtures
    ...
    url = fixture_url("profileComponents?filter[profileComponents][group]=CROR")
